...
export default function CartScreen() {
  ...
  const handleCheckout = useCallback(() => {
    ...
    router.replace('/orders/invoicescreen');
  }, [selectedItems.size, user?.id]);
  ...
  const renderCartItem = useCallback(({ item }: { item: CartItem }) => {
    ...
    return (
      <View style={styles.cartItem}>
        ...
        <Image source={{ uri: item.product.thumbnail || undefined }} style={styles.cartItemImage} />
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Bạn cần có tài khoản để mua hàng</Text>
            <Text style={styles.modalMessage}>
              Hãy đăng ký tài khoản để tiếp tục mua hàng.
            </Text>
