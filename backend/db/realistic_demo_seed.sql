...
-- Vietnamese VND demo seed dataset for PostgreSQL.
-- Demo logins:
...
--   https://d35ci4s1xmcpe.cloudfront.net/assets/seed/
...
values
  ('admin@ecommerce.local', crypt('Admin@123', gen_salt('bf', 8)), 'Quản trị hệ thống', '+84901111001', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/users/admin-avatar.jpg', 'active', true, '2026-03-01T08:00:00+07', '2026-04-10T08:00:00+07'),
  ('seller.tech@ecommerce.local', crypt('Seller@123', gen_salt('bf', 8)), 'Phạm Quốc Đạt', '+84901222002', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/users/seller-tech-avatar.jpg', 'active', true, '2026-03-03T09:00:00+07', '2026-04-10T09:00:00+07'),
  ('seller.home@ecommerce.local', crypt('Seller@123', gen_salt('bf', 8)), 'Trần Hoàng Nam', '+84901333003', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/users/seller-home-avatar.jpg', 'active', true, '2026-03-04T09:30:00+07', '2026-04-10T09:30:00+07'),
  ('chau.customer@ecommerce.local', crypt('Customer@123', gen_salt('bf', 8)), 'Nguyễn Minh Châu', '+84903777011', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/users/chau-avatar.jpg', 'active', true, '2026-03-08T19:15:00+07', '2026-04-12T12:00:00+07'),
  ('khang.customer@ecommerce.local', crypt('Customer@123', gen_salt('bf', 8)), 'Trần Minh Khang', '+84903888022', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/users/khang-avatar.jpg', 'active', true, '2026-03-10T08:45:00+07', '2026-04-12T19:10:00+07'),
  ('mai.customer@ecommerce.local', crypt('Customer@123', gen_salt('bf', 8)), 'Lê Thu Mai', '+84903999033', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/users/mai-avatar.jpg', 'active', true, '2026-03-12T20:10:00+07', '2026-04-11T14:45:00+07')
...
from (values
  ('Apple', 'Thiết bị và phụ kiện Apple chính hãng cho nhu cầu sử dụng hằng ngày.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/brands/apple-logo.jpg', '2026-03-05T08:00:00+07'::timestamptz, '2026-03-05T08:00:00+07'::timestamptz),
  ('Samsung', 'Điện thoại và phụ kiện Samsung phổ biến tại thị trường Việt Nam.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/brands/samsung-logo.jpg', '2026-03-05T08:05:00+07'::timestamptz, '2026-03-05T08:05:00+07'::timestamptz),
  ('Xiaomi', 'Thiết bị thông minh và đồ gia dụng có mức giá dễ tiếp cận.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/brands/xiaomi-logo.jpg', '2026-03-05T08:10:00+07'::timestamptz, '2026-03-05T08:10:00+07'::timestamptz),
  ('Logitech', 'Phụ kiện làm việc và gaming cho góc máy cá nhân.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/brands/logitech-logo.jpg', '2026-03-05T08:15:00+07'::timestamptz, '2026-03-05T08:15:00+07'::timestamptz),
  ('Anker', 'Phụ kiện sạc nhanh và pin dự phòng cho điện thoại, laptop.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/brands/anker-logo.jpg', '2026-03-05T08:20:00+07'::timestamptz, '2026-03-05T08:20:00+07'::timestamptz),
  ('JBL', 'Thiết bị âm thanh di động cho giải trí trong nhà và ngoài trời.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/brands/jbl-logo.jpg', '2026-03-05T08:25:00+07'::timestamptz, '2026-03-05T08:25:00+07'::timestamptz),
  ('Ecovacs', 'Robot hút bụi và thiết bị vệ sinh thông minh cho gia đình.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/brands/ecovacs-logo.jpg', '2026-03-05T08:30:00+07'::timestamptz, '2026-03-05T08:30:00+07'::timestamptz)
...
from (values
  ('Điện tử', 'electronics', 'Điện thoại, âm thanh và phụ kiện cho nhu cầu số hằng ngày.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/categories/electronics.jpg', '2026-03-06T09:00:00+07'::timestamptz, '2026-03-06T09:00:00+07'::timestamptz),
  ('Nhà cửa & đời sống', 'home-living', 'Thiết bị thông minh và đồ dùng tiện ích cho gia đình hiện đại.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/categories/home-living.jpg', '2026-03-06T09:05:00+07'::timestamptz, '2026-03-06T09:05:00+07'::timestamptz)
...
from (values
  ('electronics', 'Điện thoại', 'smartphones', 'Điện thoại phổ thông và flagship cho luồng mua hàng demo.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/categories/smartphones.jpg', '2026-03-06T09:10:00+07'::timestamptz, '2026-03-06T09:10:00+07'::timestamptz),
  ('electronics', 'Âm thanh', 'audio', 'Tai nghe, loa di động và thiết bị âm thanh không dây.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/categories/audio.jpg', '2026-03-06T09:12:00+07'::timestamptz, '2026-03-06T09:12:00+07'::timestamptz),
  ('electronics', 'Phụ kiện', 'accessories', 'Cáp sạc, củ sạc và phụ kiện thiết thực cho thiết bị di động.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/categories/accessories.jpg', '2026-03-06T09:14:00+07'::timestamptz, '2026-03-06T09:14:00+07'::timestamptz),
  ('home-living', 'Nhà thông minh', 'smart-home', 'Robot và thiết bị thông minh cho sinh hoạt hằng ngày.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/categories/smart-home.jpg', '2026-03-06T09:16:00+07'::timestamptz, '2026-03-06T09:16:00+07'::timestamptz),
  ('home-living', 'Góc làm việc', 'desk-setup', 'Thiết bị hỗ trợ làm việc tại nhà gọn gàng và hiệu quả.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/categories/desk-setup.jpg', '2026-03-06T09:18:00+07'::timestamptz, '2026-03-06T09:18:00+07'::timestamptz)
...
select
  ...
  seeded.updated_at
from (values
  ('smartphones', 'Apple', 'seller.tech@ecommerce.local', 'IP15-128-BLK', 'iPhone 15 128GB', 'iphone-15-128gb-black', 'iPhone cân bằng cho nhu cầu chụp ảnh và sử dụng hằng ngày.', 'Apple iPhone 15 bộ nhớ 128GB, pin ổn định, camera kép đáng tin cậy và phù hợp với người dùng cần một chiếc máy cao cấp gọn nhẹ.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/iphone-15-thumbnail.jpg', 18990000.00, '2026-03-20T09:00:00+07'::timestamptz, '2026-03-18T09:00:00+07'::timestamptz, '2026-04-04T15:30:00+07'::timestamptz),
  ('smartphones', 'Samsung', 'seller.tech@ecommerce.local', 'SGS24-256-GRY', 'Samsung Galaxy S24 256GB', 'samsung-galaxy-s24-256gb-gray', 'Máy Android nhỏ gọn, màn hình đẹp và camera mạnh.', 'Samsung Galaxy S24 256GB màu xám graphite, phù hợp với người dùng muốn hiệu năng cao, màn hình đẹp và trải nghiệm Android ổn định.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/samsung-s24-thumbnail.jpg', 15990000.00, '2026-03-21T09:00:00+07'::timestamptz, '2026-03-19T09:00:00+07'::timestamptz, '2026-04-10T09:00:00+07'::timestamptz),
  ('smartphones', 'Xiaomi', 'seller.tech@ecommerce.local', 'RDN13-256-BLK', 'Redmi Note 13 8GB 256GB', 'redmi-note-13-8gb-256gb-black', 'Điện thoại phổ thông có bộ nhớ lớn và pin tốt.', 'Redmi Note 13 với RAM 8GB, bộ nhớ 256GB, màn hình OLED và mức giá dễ tiếp cận cho người dùng phổ thông.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/redmi-note-13-thumbnail.jpg', 4990000.00, '2026-03-22T09:00:00+07'::timestamptz, '2026-03-20T09:00:00+07'::timestamptz, '2026-04-11T10:00:00+07'::timestamptz),
  ('audio', 'Apple', 'seller.tech@ecommerce.local', 'APP2-USBC', 'AirPods Pro 2 USB-C', 'airpods-pro-2-usbc', 'Tai nghe chống ồn cao cấp cho hệ sinh thái Apple.', 'AirPods Pro 2 hộp sạc USB-C, chống ồn chủ động, xuyên âm tự nhiên và kết nối nhanh với iPhone, iPad, MacBook.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/airpods-pro-2-thumbnail.jpg', 5790000.00, '2026-03-23T09:00:00+07'::timestamptz, '2026-03-21T09:00:00+07'::timestamptz, '2026-04-05T14:00:00+07'::timestamptz),
  ('desk-setup', 'Logitech', 'seller.tech@ecommerce.local', 'MXM3S-GRAPH', 'Logitech MX Master 3S', 'logitech-mx-master-3s-graphite', 'Chuột văn phòng cao cấp cho làm việc nhiều giờ.', 'Logitech MX Master 3S màu graphite, click êm, dáng cầm công thái học và cuộn nhanh cho dân văn phòng, designer, developer.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/mx-master-3s-thumbnail.jpg', 2390000.00, '2026-03-24T09:00:00+07'::timestamptz, '2026-03-22T09:00:00+07'::timestamptz, '2026-04-08T11:00:00+07'::timestamptz),
  ('accessories', 'Anker', 'seller.tech@ecommerce.local', 'ANK65-GAN', 'Củ sạc Anker Prime 65W GaN', 'anker-prime-65w-gan-charger', 'Củ sạc nhanh nhỏ gọn cho điện thoại, tablet và laptop.', 'Củ sạc Anker Prime 65W GaN với hai cổng USB-C, phù hợp cho người thường xuyên di chuyển và muốn dùng một củ sạc cho nhiều thiết bị.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/anker-65w-thumbnail.jpg', 890000.00, '2026-03-25T09:00:00+07'::timestamptz, '2026-03-23T09:00:00+07'::timestamptz, '2026-04-04T15:30:00+07'::timestamptz),
  ('audio', 'JBL', 'seller.home@ecommerce.local', 'JBLFLIP6-BLK', 'Loa Bluetooth JBL Flip 6', 'jbl-flip-6-black', 'Loa di động chống nước cho nghe nhạc hằng ngày.', 'JBL Flip 6 có chuẩn chống nước IP67, âm thanh mạnh mẽ và pin đủ dùng cho phòng làm việc, dã ngoại hoặc cuối tuần.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/jbl-flip-6-thumbnail.jpg', 2690000.00, '2026-03-26T09:00:00+07'::timestamptz, '2026-03-24T09:00:00+07'::timestamptz, '2026-04-12T11:30:00+07'::timestamptz),
  ('smart-home', 'Ecovacs', 'seller.home@ecommerce.local', 'ECO-N8', 'Robot hút bụi Ecovacs Deebot N8', 'ecovacs-deebot-n8', 'Robot hút bụi lau nhà phù hợp căn hộ và nhà phố.', 'Ecovacs Deebot N8 hỗ trợ lập bản đồ, hút bụi và lau nhà, phù hợp cho gia đình bận rộn cần tự động hóa việc vệ sinh.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/ecovacs-n8-thumbnail.jpg', 5990000.00, '2026-03-27T09:00:00+07'::timestamptz, '2026-03-25T09:00:00+07'::timestamptz, '2026-04-10T09:30:00+07'::timestamptz),
  ('smart-home', 'Xiaomi', 'seller.home@ecommerce.local', 'XM-AIRFRY45', 'Nồi chiên không dầu Xiaomi Smart Air Fryer 4.5L', 'xiaomi-smart-air-fryer-45l', 'Nồi chiên thông minh cho bữa ăn nhanh và ít dầu hơn.', 'Xiaomi Smart Air Fryer 4.5L hỗ trợ hẹn giờ qua app, dung tích vừa đủ cho gia đình nhỏ và các món ăn hằng ngày.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/air-fryer-thumbnail.jpg', 1790000.00, '2026-03-28T09:00:00+07'::timestamptz, '2026-03-26T09:00:00+07'::timestamptz, '2026-04-12T11:30:00+07'::timestamptz),
  ('accessories', 'Samsung', 'seller.tech@ecommerce.local', 'SS25W-USBC', 'Củ sạc Samsung USB-C 25W', 'samsung-25w-usb-c-charger', 'Củ sạc nhanh cơ bản cho điện thoại Galaxy.', 'Củ sạc Samsung 25W USB-C nhỏ gọn, phù hợp cho người dùng Galaxy cần một bộ sạc chính hãng với chi phí hợp lý.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/samsung-25w-thumbnail.jpg', 390000.00, '2026-03-29T09:00:00+07'::timestamptz, '2026-03-27T09:00:00+07'::timestamptz, '2026-04-09T08:00:00+07'::timestamptz),
  ('accessories', 'Anker', 'seller.tech@ecommerce.local', 'QRTEST-CABLE-10K', 'Cáp test QR 10K', 'qr-test-cable-10k', 'Sản phẩm giá thấp để kiểm thử thanh toán QR.', 'Cáp test QR 10K dùng cho luồng kiểm thử đặt hàng và thanh toán QR với giá sản phẩm 10.000đ.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/anker-65w-thumbnail.jpg', 10000.00, '2026-04-15T09:00:00+07'::timestamptz, '2026-04-15T09:00:00+07'::timestamptz, '2026-04-15T09:00:00+07'::timestamptz),
  ('accessories', 'Samsung', 'seller.tech@ecommerce.local', 'QRTEST-STICKER-10K', 'Miếng dán test QR 10K', 'qr-test-sticker-10k', 'Sản phẩm phụ kiện 10.000đ để kiểm thử thanh toán QR.', 'Miếng dán test QR 10K dùng để tạo đơn hàng giá thấp khi kiểm thử QR payment trên mobile app.', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/samsung-25w-thumbnail.jpg', 10000.00, '2026-04-15T09:05:00+07'::timestamptz, '2026-04-15T09:05:00+07'::timestamptz, '2026-04-15T09:05:00+07'::timestamptz)
...
from (values
  ('iphone-15-128gb-black', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/iphone-15-front.jpg', true, 1, '2026-03-18T09:05:00+07'::timestamptz),
  ('iphone-15-128gb-black', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/iphone-15-back.jpg', false, 2, '2026-03-18T09:06:00+07'::timestamptz),
  ('samsung-galaxy-s24-256gb-gray', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/samsung-s24-front.jpg', true, 1, '2026-03-19T09:05:00+07'::timestamptz),
  ('samsung-galaxy-s24-256gb-gray', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/samsung-s24-lifestyle.jpg', false, 2, '2026-03-19T09:06:00+07'::timestamptz),
  ('redmi-note-13-8gb-256gb-black', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/redmi-note-13-front.jpg', true, 1, '2026-03-20T09:05:00+07'::timestamptz),
  ('airpods-pro-2-usbc', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/airpods-pro-2-case.jpg', true, 1, '2026-03-21T09:05:00+07'::timestamptz),
  ('logitech-mx-master-3s-graphite', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/mx-master-3s-top.jpg', true, 1, '2026-03-22T09:05:00+07'::timestamptz),
  ('anker-prime-65w-gan-charger', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/anker-65w-main.jpg', true, 1, '2026-03-23T09:05:00+07'::timestamptz),
  ('jbl-flip-6-black', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/jbl-flip-6-front.jpg', true, 1, '2026-03-24T09:05:00+07'::timestamptz),
  ('jbl-flip-6-black', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/jbl-flip-6-outdoor.jpg', false, 2, '2026-03-24T09:06:00+07'::timestamptz),
  ('ecovacs-deebot-n8', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/ecovacs-n8-main.jpg', true, 1, '2026-03-25T09:05:00+07'::timestamptz),
  ('xiaomi-smart-air-fryer-45l', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/air-fryer-main.jpg', true, 1, '2026-03-26T09:05:00+07'::timestamptz),
  ('samsung-25w-usb-c-charger', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/samsung-25w-main.jpg', true, 1, '2026-03-27T09:05:00+07'::timestamptz),
  ('qr-test-cable-10k', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/anker-65w-main.jpg', true, 1, '2026-04-15T09:10:00+07'::timestamptz),
  ('qr-test-sticker-10k', 'https://d35ci4s1xmcpe.cloudfront.net/assets/seed/products/samsung-25w-main.jpg', true, 1, '2026-04-15T09:12:00+07'::timestamptz)
...
from (values
  ('chau.customer@ecommerce.local', 'ORD-202604010001', 'iphone-15-128gb-black', 5, 'Máy dùng mượt, pin đủ cho một ngày làm việc và camera chụp rất ổn. Giao hàng đúng hẹn.', array['https://d35ci4s1xmcpe.cloudfront.net/assets/seed/reviews/review-iphone-15.jpg']::text[], '2026-04-06T20:15:00+07'::timestamptz, '2026-04-06T20:15:00+07'::timestamptz),
